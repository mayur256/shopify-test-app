...
export interface BillingConfig {
    [plan: string]: BillingConfigOneTimePlan | BillingConfigSubscriptionPlan | BillingConfigUsagePlan;
}
...
export declare type CurrentAppInstallation = OneTimePurchases & ActiveSubscriptions;
